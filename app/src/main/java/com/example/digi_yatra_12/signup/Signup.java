...
//                        getotpbutton.setBackgroundColor(getResources().getColor(R.color.design_default_color_primary_dark));
//

                        getotpbutton.setBackgroundColor(getotpbutton.getContext().getResources().getColor(R.color.design_default_color_primary_dark));
//                            @Override
